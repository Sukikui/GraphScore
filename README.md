...
| **Examples**    | `correlate mastora bnp`<br>`correlate qanadli troponin -c custom/clinical_data.csv`<br>`correlate mastora risk -g custom/graphs/ -o max_transversal_obstruction_propagated`<br>`correlate mastora bnp --all-attributes`<br>`correlate qanadli risk -a`<br>`correlate mastora bnp -v`<br>`correlate qanadli risk -a -v`                                                                                                                                                                      |
